...
public class FireVignette : Vignette
{
    ...
    {
        m_EffectName = Status.Burn.ToString();          //burn damage effect so it gets the name of the burn effect
        m_ShaderName = "Hidden/FireVignette";
        base.Awake();
    }
